...
[Home](./index.md) &gt; [@thirdweb-dev/react](./react.md) &gt; [useNFTMintToSelfMutation](./react.usenftminttoselfmutation.md)

## useNFTMintToSelfMutation() function
...
```typescript
declare function useNFTMintToSelfMutation(contract?: Erc721<any>): react_query.UseMutationResult<_thirdweb_dev_sdk.TransactionResultWithId<_thirdweb_dev_sdk.NFTMetadataOwner>, unknown, string | {
