...
```typescript
export declare function useClaimConditions<TContract extends NFTDrop | EditionDrop | TokenDrop | SignatureDrop | SmartContractReturnType>(...[contract, tokenId]: ActiveClaimConditionParams<TContract>): import("react-query").UseQueryResult<{
    snapshot?: {
        address: string;
        maxClaimable: string;
    }[] | undefined;
