...
[Home](./index.md) &gt; [@thirdweb-dev/react](./react.md) &gt; [useResolvedContract](./react.useresolvedcontract.md)

## useResolvedContract() function
...
```typescript
declare function useResolvedContract(contractAddress?: string): {
