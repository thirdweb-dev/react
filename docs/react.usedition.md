...
[Home](./index.md) &gt; [@thirdweb-dev/react](./react.md) &gt; [usEdition](./react.usedition.md)
...
```typescript
export declare function usEdition(contract: RequiredParam<Erc1155>, tokenId: RequiredParam<BigNumberish>): import("react-query").UseQueryResult<{
    metadata: {
