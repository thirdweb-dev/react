...
```typescript
export declare function useContractMetadata(contractAddress: RequiredParam<string>): import("react-query").UseQueryResult<unknown, unknown>;
```
...
import("react-query").UseQueryResult&lt;unknown, unknown&gt;
