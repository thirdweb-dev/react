...
|  --- | --- | --- | --- |
|  [authUrl?](./react.thirdwebproviderprops.authurl.md) |  | string | <b><i>(BETA)</i></b> <i>(Optional)</i> The base URL of the backend endpoints for wallet authentication. These endpoints should include /login and /logout route. |
